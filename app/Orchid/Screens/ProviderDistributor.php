...
class ProviderDistributor extends Screen
{
    /**
     * Display header name.
     *
            ...
            Layout::table('users', [
                ...
                TD::make('Действия')
                    ...
                    ->render(function (User $user) {
                        return Button::make("Верифицировать")
                            ->method('aprove')
    ...
    {
        $user->subroles()->sync(3);
        Alert::info($user->name . ' Верифицирован');
        return redirect()->route('platform.distributors');
    }
}
