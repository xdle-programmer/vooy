                            ...
                            @if (Auth::check())
                                <div class="tender-header__main-buttons">
                                    ...
                                    @if($role->slug == 'provider')
                                        <div onclick="openReview()" class="tender-header__main-button button button--small">Ответить на тендер
                ...
                <div class="layout">
                    ...
                    @if ($tender->products)
                        @foreach ($tender->products as $key => $product)
                            <div id="tender-table-product-{{$product->id}}" class="tender-row tender-row--product">
                                ...
                                @if ($product->attachments->first())
                                    ...
                                    <div class="tender-row__item" data-product-img-slider="{{$path}}">
                                        <div class="tender-row__preview tender-row__preview--zoom">
                                            <div class="tender-row__preview-zoom-text">{{$photoCount}} фото</div>
