                                        ...
                                        <div id="review-{{$review->id}}" class="border-block offer tenders-chat">
                                                ...
                                                <div
                                                    ...
                                                    <div class="offer__manufacturer-button-message">
                                                        ...
                                                        <div class="offer__manufacturer-button-message-count">
                                                            <div class="offer__manufacturer-button-message-count-inner">
                                                                <div
                                            ...
                                            <div class="offer__header">
                                                <div class="manufacturer">
                                                    ...
                                                    <div class="manufacturer__title">{{$review->provider->name}}</div>
                                                    <div class="manufacturer__options">
                                                        ...
                                                        <div class="manufacturer__option">
                                                            ...
                                                            <div class="manufacturer__option-value">Мужская одежда</div>
                                                        </div>
                                                        <div class="manufacturer__option">
                                                        ...
                                                        <div class="manufacturer__option">
                                                            <div class="manufacturer__option-name">Товаров в наличии:
                                                            </div>
                                                    ...
                                                    <div class="manufacturer__reviews">
                                                        <div class="reviews">
                                                            ...
                                                            <div class="reviews__button button">Посмотреть отзывы</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="tenders-chat__wrapper">
                                                <div class="tenders-chat__content" data-chat-name="1">
                                                    <div class="chat">
                                                        <div class="chat__title">Переговоры с "Первый поставщик"</div>
                                                        <div class="chat__messages">
                                                            <div class="chat__date">08.05.2021</div>
                                                            <div class="chat__message">
                                                                <div class="chat__message-content">
                                                                    <div class="chat__message-content-text">Уверены, что
                                                                        уложитесь в
                                                            ...
                                                            <div class="chat__message chat__message--invert">
                                                                <div class="chat__message-content">
                                                                    <div class="chat__message-content-text">Нет, такой
                                                                        ткани
                                                                        нет
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="chat__message">
                                                                <div class="chat__message-content">
                                                                    <div class="chat__message-content-text">Понял</div>
                                                                </div>
                                                                <div class="chat__message-time">13:15</div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <textarea class="chat__form-wrapper-input"
                                                            ...
                                                            <div class="chat__form-buttons">
                                                                <label class="chat__form-file-input-label">
                                                                    <div class="chat__form-file-input-text">Прикрепить
                                                                        файл
                                                                    </div>
                                                ...
                                                <div id="review-{{$review->id}}"
                                                    ...
                                                    <div class="offer__header">
                                                        <div class="manufacturer">
                                                            ...
                                                            {{--<img class="manufacturer__logo" src="images/examples/manufacturer/logo/manufacturer-logo-1.jpg">--}}
                                                            <div
                                                                class="manufacturer__title">{{$review->provider->name}}</div>
                                                            <div class="manufacturer__options">
                                                                <div class="manufacturer__option">
                                                                    <div class="manufacturer__option-name">Город:</div>
                                                                    <div
                                                                ...
                                                                <div class="manufacturer__option">
                                                                    <div class="manufacturer__option-name">Категория:
                                                                    </div>
                                                                ...
                                                                <div class="chat__messages">
                                                                    ...
                                                                    <div class="chat__message">
                                                                        <div class="chat__message-content">
                                                                            ...
                                                                            <div class="chat__message-content-images">
                                                                                <img
                                                                                    class="chat__message-content-image"
                                                                                    src="images/examples/products-preview/products-preview-3.jpg">
                                                                            </div>
                                    ...
                                    @foreach ($tender->products as $key => $product)
                                        <div class="border-block offer tenders-chat">
                                                ...
                                                <div class="offer__header-product">
                                                    ...
                                                    @if ($product->attachments->first())
                                                        ...
                                                        <div class="offer__header-preview"
                                                             data-product-img-slider="{{$path}}">
                                                            <div class="offer__header-preview-zoom-text">{{$photoCount}}
                                                                фото
                                                            </div>
                                                    ...
                                                    @else
                                                        <div class="offer__header-preview"
                                                             data-product-img-slider="../storage/tenderProducts/empty.jpg">
                                                            <div class="offer__header-preview-zoom-text">0 фото</div>
                                                            <img class="offer__header-preview-img"
                                                                 src="../storage/tenderProducts/empty.jpg">
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div class="offer__header-options">
                                                        <div class="offer__header-option">
                                                            <div class="offer__header-option-name">Количество:</div>
                                                            <div
                                                                class="offer__header-option-value">{{$product->count}}</div>
                                                        </div>
                                                        <div class="offer__header-option">
                                                            <div class="offer__header-option-name">Образец:</div>
                                                            @if($product->sample)
                                                                <div class="offer__header-option-value">Обязателен</div>
                                                            @else
                                                                <div class="offer__header-option-value">Необязателен
                                                                </div>
                                                            @endif
                                                        </div>
                                                        <div class="offer__header-option">
                                                            <div class="offer__header-option-name">Комментарий:</div>
                                                            <div
                                            ...
                                            @foreach($product->reviews as $revKey => $item)
                                                <div class="tender-row tender-row--offer-with-manufacturer">
                                                    ...
                                                    <div class="tender-row__item tender-row__item--middle">
                                                        <div class="tender-row__item-options">
                                                            ...
                                                            <div class="tender-row__item-option">
                                                                <div class="tender-row__item-title">Предложение</div>
                                                                <div
                                                                    class="tender-row__item-text">{{$item->title}}</div>
                                                            </div>
                                                            <div class="tender-row__item-option">
                                                                <div class="tender-row__item-title">Комментарий</div>
                                                                <div
                                                    ...
                                                    <div
                                                        class="tender-row__item tender-row__item--big">{{$item->count}}</div>
                                                    <div class="tender-row__item tender-row__item--big">{{$item->price}}
                                                        ₽
                                                    </div>
                                                    <div
                                                ...
                                                <div class="tenders-chat__wrapper tenders-chat__wrapper--in-row">
                                                    <div class="tenders-chat__content" data-chat-name="1">
                                                        <div class="chat">
                                            ...
                                            <div class="tender-row tender-row--offer-with-manufacturer">
                                                <div class="tender-row__item"
                                                     data-product-img-slider="images/examples/product/big/product-1.jpg,images/examples/product/big/product-2.jpg,images/examples/product/big/product-3.jpg,images/examples/product/big/product-4.jpg,images/examples/product/big/product-5.jpg,images/examples/product/big/product-6.jpg">
                                                    <div class="tender-row__preview tender-row__preview--zoom">
                                                        <div class="tender-row__preview-zoom-text">6 фото</div>
                                                        <img class="tender-row__preview-img"
                                                             src="images/examples/products-preview/products-preview-5.jpg">
                                                    </div>
                                                </div>
                                                <div class="tender-row__item tender-row__item--middle">
                                                    <div class="tender-row__item-options">
                                                        <div class="tender-row__item-option">
                                                            <div class="tender-row__item-text tender-row__item-text--bold">
                                                                Второй
                                                                поставщик
                                                            </div>
                                                        </div>
                                                        <div class="tender-row__item-option">
                                                            <div class="tender-row__item-title">Предложение</div>
                                                            <div class="tender-row__item-text">Синие джинсы</div>
                                                        </div>
                                                        <div class="tender-row__item-option">
                                                            <div class="tender-row__item-title">Комментарий</div>
                                                            <div class="tender-row__item-text">Очень длинный комментарий в
                                                                несколько
                                                                строк с переносом на другие строки
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="tender-row__item tender-row__item--big">2 000</div>
                                                <div class="tender-row__item tender-row__item--big">20 000 ₽</div>
                                                <div class="tender-row__item tender-row__item--big">20 дней</div>
                                                <div class="tender-row__item">
                                                    <svg class="tender-row__item-icon tender-row__item-icon--not-check">
                                                        <use xlink:href="../images/icons/icons-sprite.svg#close"></use>
                                                    </svg>
                                                ...
                                                <div class="tender-row__item">
                                                    <div
                                                        class="offer__manufacturer-button offer__manufacturer-button--center offer__manufacturer-button--green">
                                                        <div class="offer__manufacturer-button-text">Выбрать победителем</div>
                                                    </div>
                                                </div>
                                                <div class="tender-row__item">
                                                    <div
                                            ...
                                            <div class="tenders-chat__wrapper tenders-chat__wrapper--in-row">
                                                <div class="tenders-chat__content" data-chat-name="2">
                                                    <div class="chat">
                                                        <div class="chat__title">Переговоры с "Второй поставщик"</div>
                                                        <div class="chat__messages">
                                                            <div class="chat__date">08.05.2021</div>
                                                            <div class="chat__message">
                                                                <div class="chat__message-content">
                                                            ...
                                                            <div class="chat__message chat__message--invert">
                                                                <div class="chat__message-content">
                                                                    <div class="chat__message-content-text">Да, у нас
                                                                        производство
                                                                        налажено. Вот фотографии производства, посмотрите
                                                                    </div>
                                                                    <div class="chat__message-content-images"><img
                                                                            class="chat__message-content-image"
                                                            ...
                                                            <div class="chat__message chat__message--invert">
                                                                <div class="chat__message-content">
                                                                    <div class="chat__message-content-text">Сегодня подготовим
                                                                    </div>
                                                                </div>
                                                                <div class="chat__message-time">13:15</div>
                                                            </div>
                                                            <div class="chat__message chat__message--invert">
                                                                <div class="chat__message-content">
                                                                    <div class="chat__message-content-text">Высылаю договор
                                                                    </div>
                                                                    <div class="chat__message-content-files"><a
                                                                            ...
                                                                            <div class="chat__message-content-file-text">
                                                                                Договор.docx
                                                                            </div>
                                                            ...
                                                            <div class="chat__message">
                                                                <div class="chat__message-content">
                                                                    <div class="chat__message-content-text">Получил, сегодня
                                                                        подпишу
                                                                    </div>
                                                                </div>
                                                                <div class="chat__message-time">13:15</div>
                                                        ...
                                                        <textarea class="chat__form-wrapper-input"
                                                            ...
                                                            <div class="chat__form-buttons">
                                                                <label class="chat__form-file-input-label">
                                                                    <div class="chat__form-file-input-text">Прикрепить файл
                                                                    </div>
                                                                    <svg class="chat__form-file-input-icon">
                                                                        <use
                                                                            xlink:href="../images/icons/icons-sprite.svg#upload"></use>
                                                                ...
                                                                <div class="chat__form-send button button--small">Отправить
                                                                    сообщение
                                                                </div>
                                                            </div>
                                                        </div>
