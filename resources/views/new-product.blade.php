                    ...
                    <div class="form__item-wrapper">
                        <div class="form__item border-block">
                            ...
                            <div class="form__item-group">
                                ...
                                <div id="new-product-categories" class="form__item-group-items">
                                    {{--
                                    <div class="form__item-group-item">
                                        <div class="placeholder">
                                            <select class="custom-select placeholder__select check-progress__select">
                                    ...
                                    <div class="form__item-group-item">
                                        <div class="placeholder">
                                            <select class="custom-select placeholder__select check-progress__select">
                                                <option value="default" selected="" disabled="" hidden="">Подкатегория
                                                </option>
                                                <option value="1">Мужская одежда</option>
                                                <option value="2">Женская одежда</option>
                                            </select>
                                            <div class="placeholder__item">Подкатегория</div>
                                        </div>
                                    </div>
                                    <div class="form__item-group-item">
                                        <div class="placeholder">
                                            <select class="custom-select placeholder__select check-progress__select">
                                                <option value="default" selected="" disabled="" hidden="">Опция товара
                                                </option>
                                                <option value="1">Мужская одежда</option>
                                                <option value="2">Женская одежда</option>
                                            </select>
                                            <div class="placeholder__item">Опция товара</div>
                                        </div>
                                    </div>
                                    <div class="form__item-group-item">
                                        <div class="placeholder">
...
@section('f_script')
    ...
    <script>
        ...
        function newCategory(category = null) {
            ...
            console.log(category_template.content)
