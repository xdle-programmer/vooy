            ...
            <div class="header-checkbox__item">
              <label class="checkbox">
                ...
                @if ($onlyActive == 'on')
                  checked
                @endif
                name="onlyActive" class="checkbox__input" type="checkbox"><span class="checkbox__item">
            ...
            <div class="header-checkbox__item">
              <label class="checkbox">
                ...
                @if ($onlyArchive == 'on')
                  checked
                @endif
                name="onlyArchive" class="checkbox__input" type="checkbox"><span class="checkbox__item">
                  <svg class="checkbox__icon">
                    <use xlink:href="../images/icons/icons-sprite.svg#check"></use>
            ...
            <div class="header-checkbox__item">
              <label class="checkbox">
                ...
                @if ($onlyMy == 'on')
                  checked
                @endif
                  name="onlyMy" class="checkbox__input" type="checkbox"><span class="checkbox__item">
                  <svg class="checkbox__icon">
                    <use xlink:href="../images/icons/icons-sprite.svg#check"></use>
